...
/**
 * Evaluate the spec_runner.js that contains additional settings.
 */
function readSpecMeta( file ) {
   'use strict';
   return require( file ).laxarSpec;
}
...
function initLaxar( config ) {
   ...
   var laxarSpec = readSpecMeta( specRunner );
